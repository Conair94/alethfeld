...
**Exception:** The QBF Rank-1 example (Example 5) is fully machine-verified with 0 sorries in Lean 4.

---

## Example 5: QBF Rank-1 Master Theorem ⭐ VERIFIED
...
- `qbf-rank1/qbf-rank1.tex` — LaTeX output
- `qbf-rank1/qbf-rank1.pdf` — Compiled PDF
...
"Admitted steps" are gaps explicitly acknowledged by the system. "Lean 4 Verified" indicates the proof compiles in Lean 4 with no `sorry` markers.
